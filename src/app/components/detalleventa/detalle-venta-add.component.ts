...
@Component({
  selector: 'app-detalle-venta-add',
  templateUrl: './detalle-venta-add.component.html'
})

export class DetalleVentaAddComponent implements OnInit {
  public articulo: articuloAddEdit;
  public articuloform: FormGroup;
  ListaArticulos: articuloAddEdit[];
  public codigoItem: number;
  public gtotal: number = this.data.subTotal;
  public gcantidad: number = this.data.cantidad;
  

  constructor
    (
      public dialogRef: MatDialogRef<DetalleVentaAddComponent>,
